...
<head>
    ...
    <title>Admin Two-Factor Authentication Code</title>
...
<body>
    <div class="container">
        ...
        <p style="font-size: 16px; line-height: 1.5; color: #333;">
            This OTP is valid for <strong>10 minutes</strong>. If you did not request this OTP, please ignore this email.
        </p>
        <div class="footer">
            <p>Thank you for securing your account with us!</p>
